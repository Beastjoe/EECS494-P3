...
public class StoreResource : MonoBehaviour {
  ...
  private void OnTriggerStay(Collider other) {
    ...
    if (gp.leftTrigger.isPressed
        && (teamIndex == 0 && other.CompareTag("outground_red")
            || teamIndex == 1 && other.CompareTag("outground_blue"))
        && (x * x + y * y >= effective_radius * effective_radius)
